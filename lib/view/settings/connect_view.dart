      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              "برای اتصال به شبکه های اجتماعی انتخاب کنید",
