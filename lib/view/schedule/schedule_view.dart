  ...
  List notArr = [
    {
      "day": "2",
      "detail":
      "شما 40 دقیقه در روز و 5 روز در هفته تمرین میکنید با این برنامه منظم شما میتوانید در آینده تغییرات را حس بکنید"
    },
    {
      "day": "14",
      "detail":
      "کاهش وزن باعث قدرت و تعادل بدن شما میشود و از آسیب های عضلانی جلوگیری میکند"
    },
  ];
