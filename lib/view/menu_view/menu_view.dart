...
import 'package:fitness_app/view/menu_view/yoga_view.dart';
...
class _MenuViewState extends State<MenuView> {
  ...
  List menuArr = [
    ...
    {"name": "وزن", "image": "assets/img/menu_weight.png", "tag": "2"},
    {"name": "خانه", "image": "assets/img/menu_home.png", "tag": "1"},
    {
      "name": "وضعیت تمرین",
      "image": "assets/img/menu_traning_status.png",
      "tag": "4"
    },
    {"name": "برنامه غذایی", "image": "assets/img/menu_meal_plan.png", "tag": "5"},
    {"name": "برنامه ریزی", "image": "assets/img/menu_schedule.png", "tag": "6"},
    {"name": "دویدن", "image": "assets/img/menu_running.png", "tag": "7"},
    {"name": "ورزش ها", "image": "assets/img/menu_exercises.png", "tag": "8"},
    {"name": "راهنمایی", "image": "assets/img/menu_tips.png", "tag": "9"},
    {"name": "تنظیمات", "image": "assets/img/menu_settings.png", "tag": "10"},
    {"name": "پشتیبانی", "image": "assets/img/menu_support.png", "tag": "11"},
    {"name": "خروج", "image": "assets/img/menu_support.png", "tag": "12"},
  ];
                    ...
                    child: SafeArea(
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(top: 20, right: 20),  // فاصله از بالا و راست
                                child: Container(
                                  height: kTextTabBarHeight,
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.end,  // قرار گرفتن در سمت راست
                                    children: [

                                      const SizedBox(width: 10),  // فاصله بین متن و تصویر
                                      Row(
                                        children: [
                                           Text(
                                            "برنامه تمرینی",
                                          ...
                                          ClipRRect(
                                            ...
                                            child: Image.asset("assets/img/img.png", width: 45, height: 45, fit: BoxFit.cover),
                                          ),
                                        ],
                                      ),
                                    ],
                                            ...
                                            return PlanRow(
                                              ...
                                              onPressed: () {
                                                if (index == 1) {
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(builder: (context) => const YogaView())
                                                  );
                                                }
                                              },
                                            );
