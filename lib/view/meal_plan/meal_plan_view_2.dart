...
class _MealPlanView2State extends State<MealPlanView2> {
  int isActiveTab = 0;
  List workArr = [
    {"name": "صبحانه", "title":"سبزیجات, ساندویچ", "image": "assets/img/f1.png"},
    {"name": "میان وعده", "title": "تخم مرغ, غلات, کره بادام زمینی", "image": "assets/img/f2.png"},
    {
      "name": "صبحانه",
      "title": "سبزیجات, ساندویچ",
      "image": "assets/img/f3.png",
    },
    {
      "name": "میان وعده",
      "title": "تخم مرغ, غلات, کره بادام زمینی",
